...
- [ ] T020 [P] [US2] Write failing camera, lens, and ND filter entity validation tests in `test/unit/features/equipment/domain/equipment_test.dart`
...
- [ ] T024 [P] [US2] Implement camera, lens, filter, provenance, normalization, and lifecycle entities in `lib/features/equipment/domain/equipment.dart`
...
- [ ] T029 [US2] Implement reusable equipment picker and one-off override controls in `lib/features/equipment/presentation/equipment_picker.dart`
